...
public class APIRecipeTest {
    ...
    public void ensureRecipe () throws Exception {
        ...
        r.addIngredient( new Ingredient( "Coffee", 8 ) );
    ...
    public void deleteRecipe () throws Exception {
        ...
        Assertions.assertEquals( 2, service.findAll().size(), "There should only be two recipe in the CoffeeMaker" );

        mvc.perform( delete( String.format( "/api/v1/recipes/%s", "Latte" ) ).contentType( MediaType.APPLICATION_JSON )
        ...
        mvc.perform( delete( String.format( "/api/v1/recipes/%s", "Espresso" ) )
                .contentType( MediaType.APPLICATION_JSON ).content( TestUtils.asJsonString( r3 ) ) )
                .andExpect( status().isOk() );

        Assertions.assertEquals( 0, service.findAll().size(), "There should only be no recipe in the CoffeeMaker" );
